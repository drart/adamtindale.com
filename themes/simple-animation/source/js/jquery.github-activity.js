		...
		this.each(function() {
			...
			$.ajax({
				...
				success: function(activity) {				
					$.each(activity, function(index, event) {
				...
				error: function(jqXHR, textStatus, errorThrown) {
					console.log('GitHub API Error:', textStatus, errorThrown, jqXHR);
					el.append($('<li>', {
						html: 'Unable to load GitHub activity due to API restrictions. You can view it directly at <a href="https://github.com/' + username + '">github.com/' + username + '</a>'
					}))
				}
			})
		})
